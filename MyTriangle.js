...
MyTriangle.prototype.initBuffers = function () {
  ...
  var a = Math.sqrt(v2[0] * v2[0] + v2[1] * v2[1] + v2[2] * v2[2]);
  var b = Math.sqrt(v3[0] * v3[0] + v3[1] * v3[1] + v3[2] * v3[2]);
  var c = Math.sqrt(v1[0] * v1[0] + v1[1] * v1[1] + v1[2] * v1[2]);
  ...
  this.origTexCoords = [0, 0, 0, c, (c - a * cos), a * Math.sqrt(1 - cos * cos)];
